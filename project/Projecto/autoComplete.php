...
<form autocomplete="off" id="foo">
  <div class="autocomplete" style="width:300px;">
     <input id="myInput" type="text" name="myCountry" placeholder="Local">
     <input id="myInputName" type="text" name="name" placeholder="name">
...
window.onload = function() {
    var src = document.getElementById("myInput"),
        dst = document.getElementById("myInputName"),
